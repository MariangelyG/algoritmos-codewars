/*Crea un array de objetos que representen ciudades. Cada objeto debe tener propiedades como
"nombre", "población" y "país". Luego, utiliza un método para crear una nueva propiedad en cada objeto que indique la densidad de
población de la ciudad (población dividida entre la superficie de la ciudad). 
...
{ nombre: "Madrid", población: 6559748, país: "España", superficie: 604, densidad: 10856.4 } ]*/
    ...
    console.log(calculaLaDensidad(cities));
